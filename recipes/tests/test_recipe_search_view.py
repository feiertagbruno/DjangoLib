...
class RecipeSearchViewTest(RecipeTestBase):
    ...
    def test_recipe_search_can_find_recipe_by_title(self):
        ...
        recipe1 = self.create_test_recipe(
            slug = "one",
            title = title1,
            author_data=self.create_test_user(username="one"),
        )
        recipe2 = self.create_test_recipe(
            slug = "two",
            title = title2,
            author_data=self.create_test_user(username="two"),
        )
